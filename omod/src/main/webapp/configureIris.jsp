...
<h3>IRIS Certificates DB Server Configuration</h3>
...
<form method="POST">
    <table>
    	<openmrs:portlet url="globalProperties" parameters="title=${title}|propertyPrefix=iris.|excludePrefix=iris.started"/>
    </table>
</form>
